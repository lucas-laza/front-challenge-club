    ...
    <div className="d-flex flex-column ">
      ...
      <div className="container mt-5">
        <div className="row my-4 mb-5">
          <h1
            className="text-align-left mb-4 fw-semibold"
            style={{ fontSize: 24 }}>
        ...
        <div className="row my-4 text-center"></div>
        <div className="row my-4 mb-5 mt-5">
          <div className="col-md-3">
            <div className="card text-center border-3 border border-primary">
              <div className="card-body">
                <h5 className="card-title d-flex flex-row align-items-center mt-1">
                  <img src={check} alt="" className="me-3" /> Des cours de
                  qualité
                </h5>
              </div>
            </div>
          ...
          <div className="col-md-3">
            <div className="card text-center border-3 border border-primary">
              <div className="card-body">
                <h5 className="card-title d-flex flex-row align-items-center mt-1">
                  <img src={learn} alt="" className="me-3" /> De la compétition
                </h5>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card text-center border-3 border border-primary">
              <div className="card-body">
                <h5 className="card-title d-flex flex-row align-items-center mt-1">
                  <img src={pig} alt="" className="me-3" /> Tarif accessible
                </h5>
              </div>
            </div>
          </div>
          <div className="col-md-3">
            <div className="card text-center border-3 border border-primary">
              <div className="card-body">
                <h5 className="card-title d-flex flex-row align-items-center mt-1">
                  <img src={laugth} alt="" className="me-3" /> Bonne ambiance
                </h5>
              </div>
            </div>
          </div>
